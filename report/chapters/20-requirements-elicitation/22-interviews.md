...
\multicolumn{4}{p{0.95\textwidth}}{\textbf{Resumen:} La entrevistada describió una rutina de gestión presencial, revisando sus cultivos fila por fila desde tempranas horas. Manifestó que su única herramienta tecnológica es un celular Samsung, usando principalmente WhatsApp para enviar fotografías de plagas o problemas técnicos a especialistas. No realiza análisis de suelo debido a limitaciones presupuestarias, por lo que su gestión depende de criterios externos o técnicos disponibles. Roxana detalló que las olas de calor impiden la acumulación de frío necesaria para la floración, anulando la producción. Respecto a la vecería, la describió como un desbalance económico preocupante que la obliga a depender estrictamente de sus ahorros personales para subsistir durante las campañas bajas. Identificó un problema crítico en la asistencia técnica: tras detectar una plaga, la solución suele tardar hasta 15 días en aplicarse debido a la baja disponibilidad de ingenieros y las distancias del fundo, tiempo en el cual la plaga se masifica. Ante la propuesta de valor de la plataforma Viora, la productora manifestó que contar con alertas tempranas sería "lo máximo" para actuar de inmediato. Expresó total confianza en el diagnóstico satelital, valorando especialmente que no requiera la compra de equipos físicos. Se mostró muy dispuesta a invertir tiempo registrando datos de fertilización y vecería a cambio de recomendaciones exactas. Finalmente, indicó que preferiría que la plataforma le asigne un especialista automáticamente para ganar tiempo ante una emergencia y que la sección de contactos es una característica indispensable para ella.} \\ [10pt]
...
\multicolumn{4}{p{0.95\textwidth}}{\textbf{Resumen:} El entrevistado describió su rutina de monitoreo iniciando con la búsqueda de datos climatológicos en fuentes externas (SENAMHI/MIDAGRI) para luego contrastarlos en campo. Manifestó que su herramienta tecnológica principal es Excel, la cual utiliza para tabular datos e historiales de parcelas por su accesibilidad. En cuanto a dispositivos, utiliza un celular marca OPPO para labores de campo y prefiere usar una laptop para el trabajo de gabinete. Además de la asesoría, se dedica a la ejecución de proyectos productivos y crianza de animales. David señaló que atiende un promedio de 75 a 100 visitas mensuales, pero indicó que tiene capacidad para aumentar este volumen si los clientes llegaran de forma automática. Identificó la temperatura, humedad y precipitación como las variables críticas de riesgo. Respecto a su captación de clientes, manifestó estar insatisfecho (calificación 4/10) con el método actual de "boca a boca", describiéndolo como poco agresivo. Destacó como una fricción crítica que el 80-85\% de los agricultores lo contactan cuando la plaga ya está avanzada, lo que reduce su tasa de éxito y afecta su prestigio profesional. Durante la evaluación del concepto de la plataforma, el entrevistado la calificó como una herramienta de gran ayuda para la toma de decisiones y la productividad profesional. Manifestó una clara disposición a integrar el sistema en su modelo de negocio y a pagar una suscripción si se le asegura un flujo constante de clientes. Como requisitos de confianza, solicitó que las alertas tengan al menos un 80\% de precisión técnica y que el sistema incluya trazabilidad completa de la parcela (historial de riego, fertilización y análisis de suelo) antes de emitir recetas de agrofármacos.} \\ [10pt]
...
\multicolumn{4}{p{0.95\textwidth}}{\textbf{Resumen:} El entrevistado describió su trabajo centrado en el monitoreo preventivo e identificación de plagas según la fenología del cultivo y el horario de muestreo (mañanas o tardes). Manifestó utilizar Excel y cuadros de mapeo para tabular datos sobre el conteo de ataques y el ciclo biológico de las plagas. Mencionó el uso de software especializado de SENASA para el seguimiento de enfermedades a nivel nacional. En cuanto a dispositivos, utiliza un celular Samsung por la portabilidad que ofrece. Paul indicó que atiende a un promedio de 150 productores mensuales mediante un proceso de muestreo poblacional por sectores. Señaló que, aunque tiene la capacidad para atender a más clientes, el tiempo de respuesta se ve afectado cuando debe realizar controles correctivos de varios días con un solo productor. Identificó el cambio climático y la variabilidad de altitudes como factores críticos. Respecto a la captación de clientes, utiliza capacitaciones grupales y reuniones comunales, calificando su satisfacción con este canal con un 6 sobre 10. Tras la validación del concepto de la plataforma Viora, el especialista calificó como muy útil la integración de índices de vegetación e historial térmico para la prevención y el ahorro de tiempo. Manifestó su disposición a pagar una suscripción si el sistema le asegura un flujo de clientes georreferenciados. Como requisitos de confianza, solicitó una precisión técnica del 75\%, actualizaciones quincenales con datos reales y la inclusión de historiales de control biológico y manejo agronómico (fertilización y encalado) antes de emitir recetas fitosanitarias.} \\ [10pt]
...
\multicolumn{4}{p{0.95\textwidth}}{\textbf{Resumen:} El entrevistado describió su rutina de monitoreo como un proceso que inicia con la preparación de materiales tradicionales (agenda, lapiceros) y formatos en Excel. Manifestó utilizar una cámara digital para evidenciar plagas y el celular como herramienta de apoyo. Además de la asesoría fitosanitaria, realiza trabajos de certificación en parcelas orgánicas. En cuanto a dispositivos, utiliza un celular marca Xiaomi y alterna su uso con una laptop para las labores de gabinete. Hugo señaló que atiende a un promedio de 50 productores mensuales, cifra que considera prudente para mantener la eficiencia técnica. Su principal canal de captación es a través de las autoridades de centros poblados y comunidades nativas, calificando su satisfacción con este método con un 8/10. Identificó como un problema crítico la resistencia de algunos productores debido a programas previos inconclusos y el hecho de que suelen contactarlo cuando la plaga ya es agresiva y visible, lo cual dificulta el éxito del control. Respecto a la propuesta de valor presentada, el especialista calificó las alertas tempranas satelitales como una herramienta primordial y de gran beneficio para los profesionales del mismo rubro. Manifestó su disposición a pagar una suscripción si el sistema optimiza su tiempo de diagnóstico y le provee clientes. Como requisitos de confianza, solicitó una precisión técnica del 90\% y la posibilidad de validar los datos del software mediante visitas de campo. Asimismo, consideró indispensable que el sistema registre el historial de manejo agronómico, fertilizaciones previas y muestras de suelo para emitir recomendaciones efectivas.} \\
